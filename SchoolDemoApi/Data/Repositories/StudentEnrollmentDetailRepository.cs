...
{
    public interface IStudentEnrollmentDetailRepository
    {
    ...
    public class StudentEnrollmentDetailRepository : IStudentEnrollmentDetailRepository
    {
        private readonly ApplicationDbContext _context;

        public StudentEnrollmentDetailRepository(ApplicationDbContext context)
        {
            _context = context;
        }
